export { productManager } from './managersFS/productManager.js';
export { cartManager } from './managersFS/cartManager.js';
...
export { userManager } from './managersMDB/userManager.js';
